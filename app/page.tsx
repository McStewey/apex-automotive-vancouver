  ...
  return (
    <main>
      ...
      <section className="economics refined-economics" id="economics">
        ...
        <div className="pricing-summary"><article><small>CUSTOMER LABOR RATE</small><strong>$135 <em>per billable hour</em></strong><p>The published labor charge paid by the customer.</p></article><article><small>OPERATOR LABOR SHARE</small><strong>$100 <em>per billable hour</em></strong><p>The portion retained by the independent operator business.</p></article><article><small>PARTS PARTICIPATION</small><strong>10% <em>of the parts list price</em></strong><p>Paid to the operator on parts used in completed repairs.</p></article></div>
      </section>
